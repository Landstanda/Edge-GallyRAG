...
try {
    ...
    [System.IO.Compression.ZipFile]::ExtractToDirectory($zipPath, "$androidSdkRoot\temp")
    
    # Move to correct location
    Move-Item -Path "$androidSdkRoot\temp\cmdline-tools" -Destination "$androidSdkRoot\cmdline-tools\latest" -Force
    Remove-Item -Path "$androidSdkRoot\temp" -Force
